...
if (config_data) {
    ...
    var idPattern_1 = config_data.idPattern || "^[abcdefghprqstuvxyz][2345679][abcdefghprqstuvxyz]$";
    ...
    config_data.vocabularies.forEach(function (voc) {
        ...
        if (voc_filename) {
            var csvData = csv_factory_1.CsvFactory.load(voc_filename, csvDelimiter_1, true);
            if (csvData) {
                ...
                if (idList_1.length !== csvData.length) {
                    ...
                    if (csv_factory_1.CsvFactory.write(voc_filename, csvData, csvDelimiter_1)) {
                        fileOkCount_1 += 1;
                    }
                }
            }
